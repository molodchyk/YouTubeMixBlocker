...
const translations = {
  fa: {
    messages: {
      ...
      popupCurrentPage: "صفحه فعلی",
      popupAllTime: "همه زمان‌ها",
      popupAllTimeByArea: "همه زمان‌ها بر اساس بخش",
      popupMixCardsBlocked: "کارت‌های Mix مسدودشده",
      popupMixUrlsCleaned: "نشانی‌های Mix پاک‌سازی‌شده",
      popupThisPage: "فهرست‌های Mix پنهان‌شده",
      popupBlockedPlacements: "کارت‌های Mix پنهان‌شده",
      popupPageEvidence: "پنهان‌شده در این صفحه",
      popupUniqueMixLists: "فهرست‌های Mix پنهان‌شده",
      popupRecommendations: "پیشنهادها",
      popupSearchResults: "نتایج جستجو",
      popupWatchSidebar: "نوار کناری تماشا",
      popupEndScreen: "صفحه پایان",
      popupShowBadge: "نمایش شمارنده نشان برای این صفحه",
      popupTheme: "پوسته",
      popupThemeSystem: "سیستم",
      popupThemeLight: "روشن",
      popupThemeDark: "تیره",
      popupShowDetails: "نمایش تفکیک بر اساس بخش",
      popupResetCounters: "بازنشانی شمارنده‌ها",
      popupCopyPageLog: "Copy page log",
      popupCopied: "Copied",
  ...
  az: {
    messages: {
      ...
      popupCurrentPage: "Cari səhifə",
      popupAllTime: "Bütün vaxtlar",
      popupAllTimeByArea: "Bütün vaxtlar üzrə sahə",
      popupMixCardsBlocked: "Bloklanan Mix kartları",
      popupMixUrlsCleaned: "Təmizlənən Mix URL-ləri",
      popupThisPage: "Gizlədilən Mix siyahıları",
      popupBlockedPlacements: "Gizlədilən Mix kartları",
      popupPageEvidence: "Bu səhifədə gizlədilənlər",
      popupUniqueMixLists: "Gizlədilən Mix siyahıları",
      popupRecommendations: "Tövsiyələr",
      popupSearchResults: "Axtarış nəticələri",
      popupWatchSidebar: "İzləmə yan paneli",
      popupEndScreen: "Son ekran",
      popupShowBadge: "Bu səhifə üçün nişan sayını göstər",
      popupTheme: "Tema",
      popupThemeSystem: "Sistem",
      popupThemeLight: "Açıq",
      popupThemeDark: "Tünd",
      popupShowDetails: "Sahə bölgüsünü göstər",
  ...
  eu: {
    messages: {
      ...
      popupCurrentPage: "Uneko orria",
      popupAllTime: "Guztira",
      popupAllTimeByArea: "Guztira eremuaren arabera",
      popupMixCardsBlocked: "Blokeatutako Mix txartelak",
      popupMixUrlsCleaned: "Garbitutako Mix URLak",
      popupThisPage: "Ezkutatutako Mix zerrendak",
      popupBlockedPlacements: "Ezkutatutako Mix txartelak",
      popupPageEvidence: "Orrialde honetan ezkutatua",
      popupUniqueMixLists: "Ezkutatutako Mix zerrendak",
      popupRecommendations: "Gomendioak",
      popupSearchResults: "Bilaketa-emaitzak",
      popupWatchSidebar: "Ikusteko alboko barra",
      popupEndScreen: "Amaierako pantaila",
      ...
      popupShowDetails: "Erakutsi eremukako banaketa",
  ...
  uz: {
    messages: {
      ...
      popupCurrentPage: "Joriy sahifa",
      popupAllTime: "Jami",
      popupAllTimeByArea: "Jami, hudud bo‘yicha",
      popupMixCardsBlocked: "Bloklangan Mix kartalari",
      popupMixUrlsCleaned: "Tozalangan Mix URLlari",
      popupThisPage: "Yashirilgan Mix roʻyxatlari",
      popupBlockedPlacements: "Yashirilgan Mix kartalari",
      popupPageEvidence: "Bu sahifada yashirilgan",
      popupUniqueMixLists: "Yashirilgan Mix roʻyxatlari",
      popupRecommendations: "Tavsiyalar",
      popupSearchResults: "Qidiruv natijalari",
      popupWatchSidebar: "Tomosha yon paneli",
      popupEndScreen: "Yakuniy ekran",
      ...
      popupShowDetails: "Hudud bo‘yicha taqsimotni ko‘rsatish",
  ...
  sq: {
    messages: {
      ...
      popupCurrentPage: "Faqja aktuale",
      popupAllTime: "Gjithsej",
      popupAllTimeByArea: "Gjithsej sipas zonës",
      popupMixCardsBlocked: "Karta Mix të bllokuara",
      popupMixUrlsCleaned: "URL Mix të pastruara",
      popupThisPage: "Lista Mix të fshehura",
      popupBlockedPlacements: "Karta Mix të fshehura",
      popupPageEvidence: "Fshehur në këtë faqe",
      popupUniqueMixLists: "Lista Mix të fshehura",
      popupRecommendations: "Rekomandime",
      popupSearchResults: "Rezultatet e kërkimit",
      popupWatchSidebar: "Shiriti anësor i shikimit",
      popupEndScreen: "Ekrani fundor",
      ...
      popupShowDetails: "Shfaq ndarjen sipas zonës",
  ...
  mk: {
    messages: {
      ...
      popupCurrentPage: "Тековна страница",
      popupAllTime: "Вкупно",
      popupAllTimeByArea: "Вкупно по област",
      popupMixCardsBlocked: "Блокирани Mix картички",
      popupMixUrlsCleaned: "Исчистени Mix URL-адреси",
      popupThisPage: "Скриени Mix листи",
      popupBlockedPlacements: "Скриени Mix картички",
      popupPageEvidence: "Скриено на оваа страница",
      popupUniqueMixLists: "Скриени Mix листи",
      popupRecommendations: "Препораки",
      popupSearchResults: "Резултати од пребарување",
      popupWatchSidebar: "Странична лента за гледање",
      popupEndScreen: "Завршен екран",
      ...
      popupShowDetails: "Прикажи разделба по област",
  ...
  hy: {
    messages: {
      ...
      popupCurrentPage: "Ընթացիկ էջ",
      popupAllTime: "Ընդհանուր",
      popupAllTimeByArea: "Ընդհանուր ըստ հատվածի",
      popupMixCardsBlocked: "Արգելափակված Mix քարտեր",
      popupMixUrlsCleaned: "Մաքրված Mix URL-ներ",
      popupThisPage: "Թաքցված Mix ցանկեր",
      popupBlockedPlacements: "Թաքցված Mix քարտեր",
      popupPageEvidence: "Թաքցված է այս էջում",
      popupUniqueMixLists: "Թաքցված Mix ցանկեր",
      popupRecommendations: "Առաջարկություններ",
      popupSearchResults: "Որոնման արդյունքներ",
      popupWatchSidebar: "Դիտման կողային վահանակ",
      popupEndScreen: "Վերջնական էկրան",
      popupShowBadge: "Ցույց տալ նշանի հաշվիչը այս էջի համար",
      popupTheme: "Թեմա",
      popupThemeSystem: "Համակարգ",
      popupThemeLight: "Բաց",
      popupThemeDark: "Մուգ",
      popupShowDetails: "Ցույց տալ բաժանումը ըստ հատվածի",
  ...
  ur: {
    messages: {
      ...
      popupCurrentPage: "موجودہ صفحہ",
      popupAllTime: "کل",
      popupAllTimeByArea: "کل، علاقے کے لحاظ سے",
      popupMixCardsBlocked: "بلاک کیے گئے Mix کارڈز",
      popupMixUrlsCleaned: "صاف کیے گئے Mix URLs",
      popupThisPage: "چھپائی گئی Mix فہرستیں",
      popupBlockedPlacements: "چھپائے گئے Mix کارڈز",
      popupPageEvidence: "اس صفحے پر چھپایا گیا",
      popupUniqueMixLists: "چھپائی گئی Mix فہرستیں",
      popupRecommendations: "تجاویز",
      popupSearchResults: "تلاش کے نتائج",
      popupWatchSidebar: "واچ سائیڈ بار",
      popupEndScreen: "اختتامی اسکرین",
      popupShowBadge: "اس صفحے کے لیے بیج کاؤنٹ دکھائیں",
      popupTheme: "تھیم",
      popupThemeSystem: "سسٹم",
      popupThemeLight: "لائٹ",
      popupThemeDark: "ڈارک",
      popupShowDetails: "علاقے کے لحاظ سے تفصیل دکھائیں",
  ...
  ne: {
    messages: {
      ...
      popupCurrentPage: "हालको पृष्ठ",
      popupAllTime: "अहिलेसम्म",
      popupAllTimeByArea: "अहिलेसम्म क्षेत्रअनुसार",
      popupMixCardsBlocked: "रोकिएका Mix कार्डहरू",
      popupMixUrlsCleaned: "सफा गरिएका Mix URL हरू",
      popupThisPage: "लुकाइएका Mix सूचीहरू",
      popupBlockedPlacements: "लुकाइएका Mix कार्डहरू",
      popupPageEvidence: "यस पृष्ठमा लुकाइएको",
      popupUniqueMixLists: "लुकाइएका Mix सूचीहरू",
      popupRecommendations: "सिफारिसहरू",
      popupSearchResults: "खोज परिणामहरू",
      popupWatchSidebar: "हेर्ने साइडबार",
      popupEndScreen: "अन्तिम स्क्रिन",
      popupShowBadge: "यो पृष्ठका लागि ब्याज गणना देखाउनुहोस्",
      popupTheme: "थिम",
      popupThemeSystem: "प्रणाली",
      popupThemeLight: "उज्यालो",
      popupThemeDark: "गाढा",
      popupShowDetails: "क्षेत्रअनुसार विवरण देखाउनुहोस्",
  ...
  pa: {
    messages: {
      ...
      popupCurrentPage: "ਮੌਜੂਦਾ ਸਫ਼ਾ",
      popupAllTime: "ਹੁਣ ਤੱਕ",
      popupAllTimeByArea: "ਹੁਣ ਤੱਕ ਖੇਤਰ ਅਨੁਸਾਰ",
      popupMixCardsBlocked: "ਬਲਾਕ ਕੀਤੇ Mix ਕਾਰਡ",
      popupMixUrlsCleaned: "ਸਾਫ਼ ਕੀਤੇ Mix URL",
      popupThisPage: "ਲੁਕਾਈਆਂ Mix ਸੂਚੀਆਂ",
      popupBlockedPlacements: "ਲੁਕਾਏ Mix ਕਾਰਡ",
      popupPageEvidence: "ਇਸ ਸਫ਼ੇ 'ਤੇ ਲੁਕਾਇਆ",
      popupUniqueMixLists: "ਲੁਕਾਈਆਂ Mix ਸੂਚੀਆਂ",
      popupRecommendations: "ਸਿਫ਼ਾਰਸ਼ਾਂ",
      popupSearchResults: "ਖੋਜ ਨਤੀਜੇ",
      popupWatchSidebar: "ਵਾਚ ਸਾਈਡਬਾਰ",
      popupEndScreen: "ਅੰਤ ਸਕ੍ਰੀਨ",
      popupShowBadge: "ਇਸ ਪੰਨੇ ਲਈ ਬੈਜ ਗਿਣਤੀ ਦਿਖਾਓ",
      popupTheme: "ਥੀਮ",
      popupThemeSystem: "ਸਿਸਟਮ",
      popupThemeLight: "ਲਾਈਟ",
      popupThemeDark: "ਡਾਰਕ",
      popupShowDetails: "ਖੇਤਰ ਅਨੁਸਾਰ ਵੇਰਵਾ ਦਿਖਾਓ",
  ...
  si: {
    messages: {
      ...
      popupCurrentPage: "වත්මන් පිටුව",
      popupAllTime: "සියලු කාලය",
      popupAllTimeByArea: "සියලු කාලය, ප්‍රදේශ අනුව",
      popupMixCardsBlocked: "අවහිර කළ Mix කාඩ්පත්",
      popupMixUrlsCleaned: "පිරිසිදු කළ Mix URL",
      popupThisPage: "සඟවා ඇති Mix ලැයිස්තු",
      popupBlockedPlacements: "සඟවා ඇති Mix කාඩ්පත්",
      popupPageEvidence: "මෙම පිටුවේ සඟවා ඇත",
      popupUniqueMixLists: "සඟවා ඇති Mix ලැයිස්තු",
      popupRecommendations: "නිර්දේශ",
      popupSearchResults: "සෙවුම් ප්‍රතිඵල",
      popupWatchSidebar: "නැරඹුම් පැති තීරුව",
      popupEndScreen: "අවසන් තිරය",
      popupShowBadge: "මෙම පිටුව සඳහා ලාංඡන ගණන පෙන්වන්න",
      popupTheme: "තේමාව",
      popupThemeSystem: "පද්ධතිය",
      popupThemeLight: "ආලෝක",
      popupThemeDark: "අඳුරු",
      popupShowDetails: "ප්‍රදේශ අනුව විස්තර පෙන්වන්න",
  ...
  ka: {
    messages: {
      ...
      popupCurrentPage: "მიმდინარე გვერდი",
      popupAllTime: "სულ",
      popupAllTimeByArea: "სულ არეების მიხედვით",
      popupMixCardsBlocked: "დაბლოკილი Mix ბარათები",
      popupMixUrlsCleaned: "გასუფთავებული Mix URL-ები",
      popupThisPage: "დამალული Mix სიები",
      popupBlockedPlacements: "დამალული Mix ბარათები",
      popupPageEvidence: "ამ გვერდზე დამალული",
      popupUniqueMixLists: "დამალული Mix სიები",
      popupRecommendations: "რეკომენდაციები",
      popupSearchResults: "ძიების შედეგები",
      popupWatchSidebar: "ყურების გვერდითი ზოლი",
      popupEndScreen: "დასასრულის ეკრანი",
      popupShowBadge: "ამ გვერდისთვის ნიშნულის მთვლელის ჩვენება",
      popupTheme: "თემა",
      popupThemeSystem: "სისტემა",
      popupThemeLight: "ღია",
      popupThemeDark: "მუქი",
      popupShowDetails: "არეების მიხედვით დაყოფის ჩვენება",
  ...
  am: {
    messages: {
      ...
      popupCurrentPage: "የአሁኑ ገጽ",
      popupAllTime: "ከመጀመሪያ ጀምሮ",
      popupAllTimeByArea: "ከመጀመሪያ ጀምሮ በቦታ",
      popupMixCardsBlocked: "የታገዱ Mix ካርዶች",
      popupMixUrlsCleaned: "የተጸዱ Mix URL-ዎች",
      popupThisPage: "የተደበቁ Mix ዝርዝሮች",
      popupBlockedPlacements: "የተደበቁ Mix ካርዶች",
      popupPageEvidence: "በዚህ ገጽ የተደበቀ",
      popupUniqueMixLists: "የተደበቁ Mix ዝርዝሮች",
      popupRecommendations: "ምክሮች",
      popupSearchResults: "የፍለጋ ውጤቶች",
      popupWatchSidebar: "የመመልከቻ ጎን አሞሌ",
      popupEndScreen: "መጨረሻ ማያ",
      popupShowBadge: "ለዚህ ገጽ የባጅ ቆጣሪን አሳይ",
      popupTheme: "ገጽታ",
      popupThemeSystem: "ስርዓት",
      popupThemeLight: "ብርሃን",
      popupThemeDark: "ጨለማ",
      popupShowDetails: "የቦታ ትንታኔን አሳይ",
...
function removeGeneratedReleaseNotes(filePath) {
  const lines = readFileSync(filePath, "utf8").split(/\r?\n/);
  let supportEmailIndex = lines.findIndex(line => line.trim() === supportEmail);
  if (supportEmailIndex === -1) {
    supportEmailIndex = lines.findIndex(line => line.trim() === "EMAIL_PLACEholder");
    if (supportEmailIndex !== -1) {
      lines[supportEmailIndex] = supportEmail;
    }
  }
  const githubURLIndex = lines.findIndex(line => line.trim() === githubURL);

  if (supportEmailIndex === -1 || githubURLIndex === -1 || githubURLIndex <= supportEmailIndex) return;

  let licenseLineIndex = githubURLIndex - 1;
  while (licenseLineIndex >= 0 && lines[licenseLineIndex].trim() === "") {
    licenseLineIndex -= 1;
  }

  let footerHeadingIndex = licenseLineIndex - 1;
  while (footerHeadingIndex >= 0 && lines[footerHeadingIndex].trim() === "") {
    footerHeadingIndex -= 1;
  }

  if (footerHeadingIndex <= supportEmailIndex + 1) return;

  const nextLines = [
    ...lines.slice(0, supportEmailIndex + 1),
    "",
    ...lines.slice(footerHeadingIndex)
  ];
...
function normalizeStoreListingFooter(filePath) {
  ...
  let headingIndex = licenseLineIndex - 1;
  while (headingIndex >= 0 && lines[headingIndex].trim() === "") {
    headingIndex -= 1;
  }

  const heading = headingIndex >= 0 ? lines[headingIndex].trim() : "Open source";
  const blockStart = headingIndex >= 0 ? headingIndex : licenseLineIndex;
  let blockEnd = githubURLIndex + 1;
  ...
  writeFileSync(filePath, `${normalized.replace(/\n*$/, "")}\n`, "utf8");
}
...
for (const fileName of readdirSync(listingDirectory).filter(fileName => fileName.endsWith(".txt"))) {
  ...
  removeGeneratedReleaseNotes(filePath);
